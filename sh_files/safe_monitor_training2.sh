...
#SBATCH --output=/mimer/NOBACKUP/groups/naiss2024-22-1336/DCMO_alj/safety_monitor_training_2.out
...
srun -n1 --overlap apptainer exec --nv /mimer/NOBACKUP/groups/naiss2024-22-404/my_container_verifai3.sif python3 /cephyr/users/luque/Alvis/DCMO/src/safety_monitor_training.py --num_steps 300 --results_dir /mimer/NOBACKUP/groups/naiss2024-22-1336/DCMO_alj/safety_monitor_reduced_2 --log_path /mimer/NOBACKUP/groups/naiss2024-22-1336/DCMO_alj/safety_monitor_reduced_2/log.csv --controllers_folder /mimer/NOBACKUP/groups/naiss2025-22-1298/CMO/experiments/checkpoints/train_faster --i_init 0 --training 1 &
wait