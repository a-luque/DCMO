...
#SBATCH -n 1
#SBATCH -t 1-00:00:00
#SBATCH --output=/mimer/NOBACKUP/groups/naiss2025-22-1298/CMO/experiments/new_exp/debug/train/mlp/smooth.out
#SBATCH --error=/mimer/NOBACKUP/groups/naiss2025-22-1298/CMO/experiments/new_exp/debug/train/mlp/smooth.err
...
srun -n1 --overlap apptainer exec --nv \
    ...
    python3 train_mlp.py \
        --h5_file "$LOCAL_H5" \
        --cnn_ckpt ./checkpoints/cnn/${H5_FILENAME}/best.pt \
        --epochs 30 \
        --batch_size 256 \
        --out_dir "/cephyr/users/mengyuan/Alvis/Desktop/mimer_naiss2025-22-1298/CMO/experiments/new_exp/train_controller/checkpoints/mlp/${H5_FILENAME}"
